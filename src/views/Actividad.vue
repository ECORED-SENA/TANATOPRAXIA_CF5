  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5   
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 ¿Cuál es la secuencia de la actividad de tanatopráctor? 
        p.mb-4 Identificar el orden de las principales actividades realizadas en el proceso de tanatopraxia.
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Organizar secuencia
            .col-auto
